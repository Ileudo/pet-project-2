...
/*#__PURE__*/
function () {
  function Difference(oldOfficer, newOfficer, itemsSelector) {
    ...
    value: function init() {
      ...
      this.forms.forEach(function (form) {
        return form.addEventListener('submit', function (e) {
          ...
          statusMessage.style.cssText = "margin-top: 15px; font-size: 18px; color: grey;";
  ...
  _createClass(VideoPlayer, [{
    ...
    value: function bindTriggers() {
      ...
      this.btns.forEach(function (btn, i) {
        try {
          var blockedElem = btn.closest('.module__video-item');
...
function (_Slider) {
  ...
  _createClass(MiniSlider, [{
      ...
      this.prev.addEventListener('click', function () {
        for (var i = _this2.slides.length - 1; i > 0; i--) {
          if (_this2.slides[i].tagName !== 'BUTTON') {
            ...
            _this2.container.prepend(lastSlide);
    ...
    key: "autoPlay",
    value: function autoPlay(timeIntervel) {
      var _this3 = this;
      ...
      [this.container, this.next, this.prev].forEach(function (elem) {
        return elem.addEventListener('mouseenter', function () {
          clearInterval(move);
        });
      });
      [this.container, this.next, this.prev].forEach(function (elem) {
        return elem.addEventListener('mouseleave', function () {
          move = setInterval(_this3.nextSlide.bind(_this3), timeIntervel);
        });
      });
    }
  }, {
